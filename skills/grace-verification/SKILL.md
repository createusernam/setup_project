...
Use this packet to drive `/diagnose` → `/tdd` or to hand off the issue to another agent without losing context.
...
## When to Use It
- Before a first serious `/build-loop` (autonomous) or `/tdd` (human-paced) run
