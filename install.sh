...
echo "=== Done ==="
echo ""
echo "Available skills (Claude Code — type in chat):"
...
echo ""
echo "OpenCode users: see COMPAT.md for skill invocation and model routing."
echo ""
echo "Model routing:"
echo "  Orchestrator  → Claude Opus 4.6+"
...
echo ""
echo "Next: open Claude Code and run /startup <project-name>"
