...
6. `/build-loop` — generate all modules sequentially with review and commits
7. `/build-loop` — generate parallel-safe modules in controller-managed waves
...
10. `/diagnose` → `/tdd error-description` — debug via semantic navigation
